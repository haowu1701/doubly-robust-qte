...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --time=140:00:00      # Adjust the time limit as needed (e.g., 24:00:00 for 24 hours)
#SBATCH --mem=42G            # Request more memory if needed
#SBATCH --job-name=bootvar_cc
#SBATCH --output=bootstrap_cc-%j.out
