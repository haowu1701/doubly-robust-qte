...
all_summaries = lapply(scenarios, function(sce) {
  ...
  res_summary = rbind(
    # AIPW_normality_q
    y1_aipw_q = calc_stats(tmp_res[, "aipw_q_q1"], m_Y1_0.5, nsample = nsample),
    y0_aipw_q = calc_stats(tmp_res[, "aipw_q_q0"], m_Y0_0.5, nsample = nsample),
    QTE_aipw_q = calc_stats(tmp_res[, "aipw_q_QTE"], QTE_0.5_true, nsample = nsample),
    
    # TMLE_normality_q
    y1_tmle = calc_stats(tmp_res[, "tmle_q1"], m_Y1_0.5, nsample = nsample),
    y0_tmle = calc_stats(tmp_res[, "tmle_q0"], m_Y0_0.5, nsample = nsample),
    QTE_tmle = calc_stats(tmp_res[, "tmle_QTE"], QTE_0.5_true, nsample = nsample),
    
    # TMLE_cpm_q
    y1_tmle_cpm = calc_stats(tmp_res[, "cpm_tmle_q1"], m_Y1_0.5, nsample = nsample),
    y0_tmle_cpm = calc_stats(tmp_res[, "cpm_tmle_q0"], m_Y0_0.5, nsample = nsample),
    QTE_tmle_cpm = calc_stats(tmp_res[, "cpm_tmle_QTE"], QTE_0.5_true, nsample = nsample),
    
    # TMLE_rq_q
    y1_tmle_rq = calc_stats(tmp_res[, "rq_tmle_q1"], m_Y1_0.5, nsample = nsample),
    y0_tmle_rq = calc_stats(tmp_res[, "rq_tmle_q0"], m_Y0_0.5, nsample = nsample),
    QTE_tmle_rq = calc_stats(tmp_res[, "rq_tmle_QTE"], QTE_0.5_true, nsample = nsample),
    ...
    # G-cpm_cdf
    y1_g = calc_stats(tmp_res[, "g_q1"], m_Y1_0.5, nsample = nsample),
    y0_g = calc_stats(tmp_res[, "g_q0"], m_Y0_0.5, nsample = nsample),
    QTE_g = calc_stats(tmp_res[, "g_QTE"], QTE_0.5_true, nsample = nsample),
    
    # IPW_cdf
    y1_iptw = calc_stats(tmp_res[, "iptw_q1"], m_Y1_0.5, nsample = nsample),
    y0_iptw = calc_stats(tmp_res[, "iptw_q0"], m_Y0_0.5, nsample = nsample),
    QTE_iptw = calc_stats(tmp_res[, "iptw_QTE"], QTE_0.5_true, nsample = nsample),
    
    # IPW_Firpo_q
    y1_firpo = calc_stats(tmp_res[, "firpo_q1"], m_Y1_0.5, nsample = nsample),
    y0_firpo = calc_stats(tmp_res[, "firpo_q0"], m_Y0_0.5, nsample = nsample),
    QTE_firpo = calc_stats(tmp_res[, "firpo_QTE"], QTE_0.5_true, nsample = nsample),
    
    # exp_TMLE_normality_q
    y1_tmle_lm_exp = calc_stats(tmp_res[, "exp_tmle_lm_q1"], m_Y1_0.5, nsample = nsample),
    y0_tmle_lm_exp = calc_stats(tmp_res[, "exp_tmle_lm_q0"], m_Y0_0.5, nsample = nsample),
    QTE_tmle_lm_exp = calc_stats(tmp_res[, "exp_tmle_lm_QTE"], QTE_0.5_true, nsample = nsample),
    
    # exp_TMLE_rq_q
    y1_tmle_rq_exp = calc_stats(tmp_res[, "exp_tmle_rq_q1"], m_Y1_0.5, nsample = nsample),
    y0_tmle_rq_exp = calc_stats(tmp_res[, "exp_tmle_rq_q0"], m_Y0_0.5, nsample = nsample),
    QTE_tmle_rq_exp = calc_stats(tmp_res[, "exp_tmle_rq_QTE"], QTE_0.5_true, nsample = nsample),
    
    # exp_AIPW_lm_q
    y1_aipw_lm_exp = calc_stats(tmp_res[, "exp_aipw_lm_q1"], m_Y1_0.5, nsample = nsample),
    y0_aipw_lm_exp = calc_stats(tmp_res[, "exp_aipw_lm_q0"], m_Y0_0.5, nsample = nsample),
    QTE_aipw_lm_exp = calc_stats(tmp_res[, "exp_aipw_lm_QTE"], QTE_0.5_true, nsample = nsample),
    
    # tc_TMLE_normality_q
    y1_tmle_lm_tc = calc_stats(tmp_res[, "tc_tmle_lm_q1"], m_Y1_0.5, nsample = nsample),
    y0_tmle_lm_tc = calc_stats(tmp_res[, "tc_tmle_lm_q0"], m_Y0_0.5, nsample = nsample),
    QTE_tmle_lm_tc = calc_stats(tmp_res[, "tc_tmle_lm_QTE"], QTE_0.5_true, nsample = nsample),
    
    # tc_TMLE_rq_q
    y1_tmle_rq_tc = calc_stats(tmp_res[, "tc_tmle_rq_q1"], m_Y1_0.5, nsample = nsample),
    y0_tmle_rq_tc = calc_stats(tmp_res[, "tc_tmle_rq_q0"], m_Y0_0.5, nsample = nsample),
    QTE_tmle_rq_tc = calc_stats(tmp_res[, "tc_tmle_rq_QTE"], QTE_0.5_true, nsample = nsample),
    
    # tc_AIPW_lm_q
    y1_aipw_lm_tc = calc_stats(tmp_res[, "tc_aipw_lm_q1"], m_Y1_0.5, nsample = nsample),
    y0_aipw_lm_tc = calc_stats(tmp_res[, "tc_aipw_lm_q0"], m_Y0_0.5, nsample = nsample),
    QTE_aipw_lm_tc = calc_stats(tmp_res[, "tc_aipw_lm_QTE"], QTE_0.5_true, nsample = nsample),
    
    # mis-link CPM estimators
    y1_aipw_mis = calc_stats(tmp_res[, "aipw_q1_mis"], m_Y1_0.5, nsample = nsample),
    y0_aipw_mis = calc_stats(tmp_res[, "aipw_q0_mis"], m_Y0_0.5, nsample = nsample),
    QTE_aipw_mis = calc_stats(tmp_res[, "aipw_QTE_mis"], QTE_0.5_true, nsample = nsample),
    
    y1_aipw_cpm_q_mis = calc_stats(tmp_res[, "aipw_cpm_q_q1_mis"], m_Y1_0.5, nsample = nsample),
    y0_aipw_cpm_q_mis = calc_stats(tmp_res[, "aipw_cpm_q_q0_mis"], m_Y0_0.5, nsample = nsample),
    QTE_aipw_cpm_q_mis = calc_stats(tmp_res[, "aipw_cpm_q_QTE_mis"], QTE_0.5_true, nsample = nsample),
    
    y1_tmle_cpm_mis = calc_stats(tmp_res[, "cpm_tmle_q1_mis"], m_Y1_0.5, nsample = nsample),
    y0_tmle_cpm_mis = calc_stats(tmp_res[, "cpm_tmle_q0_mis"], m_Y0_0.5, nsample = nsample),
    QTE_tmle_cpm_mis = calc_stats(tmp_res[, "cpm_tmle_QTE_mis"], QTE_0.5_true, nsample = nsample)
  )
